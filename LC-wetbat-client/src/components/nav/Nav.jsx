    ...
    <nav className='nav-main-container'>
      <div className="top-nav-container">
        <div className="top-nav-left">
          <FontAwesomeIcon icon={faThLarge} className='top-nav-icon' id='left-nav-icon' />
          <h2><Link to='/' id='home-link'>Wet Bat Travel</Link></h2>
        </div>
        <div className="top-nav-right">
          <input type="text" placeholder='Search' id='nav-search' />
          <FontAwesomeIcon icon={faBell} className='top-nav-icon' />
          <FontAwesomeIcon icon={faComment} className='top-nav-icon' />
          <FontAwesomeIcon icon={faCog} className='top-nav-icon' />
